...
export function NoteForm({onSubmit,onAddTag,availableTags} NoteFormProps){
    ...
    function handleSubmit(e:FormEvent){
        e.preventDefault()
        onSubmit({title:titleRef.current!.value, markdownRef:markdownRef.current!.value, tags:[]})//may be null (!) but cause it is required it is never null?
    }
                        ...
                        <Form.Group controlId="tags">
                            ...
                            <CreatableReactSelect
                                onCreateOption={label=>{
                                    ...
                                    onAddTag(newTag)
                                    onSelectedTags(prev=>[...prev, newTag])
                                }}
